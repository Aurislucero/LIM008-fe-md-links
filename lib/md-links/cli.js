...
program.arguments('<path>').option('-s, --stats', 'mostrar los unicos y rotos').option('-v, --validate', 'validar los link y mostrar si la ruta es valida').option('-h, --help', 'validar los link y mostrar si la ruta es valida').action(_index.mdLinks).parse(process.argv);
var options = {
